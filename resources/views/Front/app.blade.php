...
<body data-instant-intensity="mousedown">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl" id="navbar">
                <a href="index.php" class="text-decoration-none mobile-logo">
                    <span class="h2 text-uppercase text-primary bg-dark">Apna</span>
                ...
                <div class="right-nav py-0">
                    <a href="{{ route('front.cart') }}" class="position-relative cart-icon">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-card">
                        <h3>Get In Touch</h3>
                        <p>Varanasi, Uttar Pradesh <br>
                            India <br>
                            creataum@gmail.com <br>
                            7652096144</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="footer-card">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('front.contact-us') }}" title="Contact Us">Contact Us</a></li>
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <div class="copy-right text-center">
                            <p>© Copyright 2022 Apna Shop. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        // Display notifications using Toastr
        ...
        $(document).ready(function() {
            // AJAX call to fetch cart count
            $.ajax({
                type: 'GET',
                url: '{{ route('front.countCart') }}',
                success: function(response) {
                    var cartCount = response.cartCount;
                    $('#cartNotification').text(cartCount);
                    if (cartCount > 0) {
