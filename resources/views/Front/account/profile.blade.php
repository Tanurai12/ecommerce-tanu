                                ...
                                <form action="" method="post" name="profileForm" id="profileForm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input value="{{ $user->phone }}" type="number" name="phone" id="phone"
                                ...
                                <form action="" method="post" name="addressForm" id="addressForm">
                                    <div class="row">
                                            ...
                                            <select name="country_id" id="country_id" class="form-control">
                                                ...
                                                @if ($countries->isNotEmpty())
                                                    @foreach ($countries as $country)
                                                        <option
                                                            {{ !empty($address) && $address->countries_id == $country->id ? 'selected' : '' }}
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input value="{{ !empty($address) ? $address->apartment : '' }}"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input value="{{ !empty($address) ? $address->note : '' }}" type="text"
                                                name="apartment" id="apartment" placeholder="Enter Your apartment detail"
                                                class="form-control">
                                            <p></p>
                                        </div>
                                        <div class="mb-3 ">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        if (errors.zip) {
                            $("#addressForm #zip").addClass('is-invalid').siblings('p').html(errors.zip[
                                    0])
                                .addClass('invalid-feedback');
                        } else {
